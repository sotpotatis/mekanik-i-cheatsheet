...
\begin{itemize}
    \item Påverkas av reaktionskrafter i $x$, $y$ och $z$-led.
    \item Påverkas av reaktionsmoment i $x$ och $z$-led. (det finns inget reaktionsmoment runt gångjärnets axel eftersom den kan rotera fritt där)
\end{itemize}
\end{ankiflashcard}
...
\end{cases}$$
\end{ankiflashcard}
\begin{ankiflashcard}{Skriv upp amplitud för påtvingade svängningar samt partikulärlösningen för dessa.}
...
\end{ankiflashcard}
\begin{ankiflashcard}{Koppla jämviktslägets position till lösning för differentialekvationen vid svängning}
    \subsection{Nämnvärda samband för svängningar}
    Notera att om ett koordinatsystem är definierat s.a. $x=0$ är fjäderns naturliga längd ges jämviktslägets position av värdet för partikulärlösningen $x_p$ till differentialekvationen.
\end{ankiflashcard}
